...
public class ApplicationDbContext : IdentityDbContext<AppUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // ProductImage: có thể gắn với Product chung hoặc với Variant cụ thể
        ...
        // Unique index: (ProductId, VariantId, SortOrder) – filter on VariantId NOT NULL
        builder.Entity<ProductImage>()
            .HasIndex(x => new { x.ProductId, x.VariantId, x.SortOrder })
            .IsUnique()
            .HasFilter("[VariantId] IS NOT NULL");

        // Ảnh chung (VariantId IS NULL) vẫn cần unique (ProductId, SortOrder) khi VariantId null
        builder.Entity<ProductImage>()
